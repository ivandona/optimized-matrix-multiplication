...
#PBS -q short_cpuQ
#PBS -o logs/outputs/mpi_base_o.txt
#PBS -e logs/outputs/mpi_base_e.txt
#PBS -J 1-12
...
for i in {1..10}; do
    ...
    mpirun.actual -n $procs ./optimized-matrix-multiplication/build/bin/algorithms/base/mpi_base $matrix_size
done
