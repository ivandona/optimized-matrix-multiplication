...
#PBS -q short_cpuQ
#PBS -o res/test_CSR_reverse.out
#PBS -e res/test_CSR_reverse.err
...
total_cores_list=(32) #2 4 8 16 32 64
src_dir="src"
bin_dir="bin"
res_dir="res"
...
# load src files
openmp_scripts=( "$src_dir"/CSR*reverse_OpenMP.c )
mpi_scripts=( "$src_dir"/CSR*reverse_MPI.c )
hybrid_scripts=( "$src_dir"/CSR*reverse_Hybrid.c )
